...
// 1. Implicit binding ==> this becomes the object from which we are calling the method

var me = {
    name : 'Tyler',
    sayName : function () {console.log(this.name, this)},
};
me.sayName();
...
// une seule règle, le this devient le contexte du scope lexical parent, la arrow fonction a sa propre scope mais pas son propre contexte
